...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('frontEnd.home')}}" target="_blank" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ config('app.name','Smart Coching') }}</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('img/user/')}}/{{ Auth::user()->photo }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        ...
        <template v-if='$gate.isAdminOrAuthor()'>
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-flag indigo"></i>
              <p>
                Course
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link to="/courses" class="nav-link">
                  <i class="fas fa-list-alt nav-icon pink"></i>
                  <p>Courses</p>
                </router-link>
              </li>
            </ul>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <!-- <li class="nav-item">
                <router-link to="/student-create" class="nav-link">
                  <i class="fas fa-user nav-icon pink"></i>
                  <p>Create Student</p>
                </router-link>
              </li> -->
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <router-link :to="{ name: 'TransactionHistory' }" class="nav-link">
                  <i class="fas fa-list-alt nav-icon pink"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-briefcase indigo"></i>
              <p>
                Reports
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link :to="{ name: 'studentReport' }" class="nav-link">
                  <i class="fas fa-user nav-icon pink"></i>
                  <p>Student</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'transactionReport' }" class="nav-link">
                  <i class="fas fa-list-alt nav-icon pink"></i>
                  <p>Transaction</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'paymentReport' }" class="nav-link">
                  <i class="fas fa-list-alt nav-icon pink"></i>
                  <p>Payment</p>
                </router-link>
              </li>
          ...
          <li class="nav-item">
            <router-link :to="{ name: 'expenditure' }" class="nav-link">
                  <i class="fas fa-list-alt nav-icon pink"></i>
                  <p>Expenditure</p>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link :to="{ name: 'message' }" class="nav-link">
                  <i class="fas fa-envelope nav-icon pink"></i>
                  <p>Message</p>
            </router-link>
          </li>
        </template>
