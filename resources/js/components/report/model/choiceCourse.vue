                ...
                <tbody>
                        ...
                        <tr v-for="(course, i) in courses.data" :key="course.course_id">
                            ...
                            <td class="academic-details">
                                <button class="btn" @click="choiceCourse(course.course_id)" id="useCourse">
...
export default {
  ...
  methods:{
      ...
      choiceCourse(course_id){
      
        axios.get('api/report/student/'+course_id)
        .then((data)=>{
            let student = data.data;
            this.$emit('getCourse', student);
